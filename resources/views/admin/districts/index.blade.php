    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 bg-gradient-dark shadow-color">
          <h6 class="text-white text-capitalize ps-3">Districts</h6>
        </div>
      </div>
        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center justify-content-center mb-0">
            <thead>
              <tr>
                <div class="col-lg-3 col-sm-6 col-12 mt-sm-0 mt-2 p-l-15 pb-3">
                  <a class="btn  filter bg-gradient-info" href="{{ route('districts.create') }}" role="button">
                   <span class="material-icons">add</span>Add new District</a>
                 </div>
               </tr>
               <tr>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <p class="text-sm font-weight-bold mb-0">{{$district->id}}</p>
                </td>
                <td>
                  <p class="text-sm font-weight-bold mb-0">{{$district->name}}</p>
                </td>
                <td>
                  @if($district->city->name)
                  <p class="text-sm font-weight-bold mb-0">{{$district->city->name}}</p>
                  @endif
                </td>
                <td class="align-middle">
                      <div class="d-flex justify-content-center ">
                          <div>
                          <a href="{{ route('districts.edit',$district->id)}}" class="" data-toggle="tooltip" data-original-title="Edit user">
