        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center justify-content-center mb-0">
            <thead>
              <tr>
                <div class="col-lg-3 col-sm-6 col-12 mt-sm-0 mt-2 p-l-15 pb-3">
                  <a class="btn  filter bg-gradient-info" href="{{route('tables.create')}}" role="button">
                   <span class="material-icons">add</span>Add new table </a>
                 </div>
               </tr>
               <tr>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <p class="text-sm font-weight-bold mb-0">{{$table->id}}</p>
                </td>
                <td>
                  <p class="text-sm font-weight-bold mb-0">{{$table->table_number}}</p>
                </td>
                 <td>
                  <p class="text-sm font-weight-bold mb-0">{{$table->booking_status}}</p>
                </td>
                <td class="align-middle">
                       <div class="d-flex justify-content-center ">
                          <div>
                          <a href="{{url ('/edit-tables')}}" class="" data-toggle="tooltip" data-original-title="Edit user">
                           <i class="material-icons ms-auto text-dark cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="  Edit">edit</i>
                          </a></div>

                             <div>
                            <a href="{{url ('/edit-tables')}}" class="" data-toggle="tooltip" data-original-title="delete user">
