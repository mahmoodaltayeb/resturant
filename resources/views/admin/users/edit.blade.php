        ...
        <div class="card-body px-0 pb-2">
          <div class="row">
            <div class="form-border rounded mt-2">
             <form role="form" action="{{url ('/users/update/'.$users->id)}}" method="Post" class="mt-4 m-5">
              @csrf
              <div class="row"> 
               <div class="col">
                <label class="form-label">First name</label>
                <div class="input-group input-group-outline mb-3">
                  <input value="{{$users->first_name}}" type="text" name="first_name" class="form-control">
                </div>
              </div>
              <div class="col">
                <label class="form-label">Last name</label>
                <div class="input-group input-group-outline mb-3">
                  <input value="{{$users->last_name}}" name="last_name" type="text" class="form-control">
                </div>
              </div>
            </div>
            <div class="row"> 
             <div class="col">
              ...
              <div class="input-group input-group-outline mb-3">
                <input value="{{$users->birthday}}" name="birthday" type="date" class="form-control">
              </div>
            </div>
            <div class="col">
          ...
          <div class="col">
            ...
            <div class="input-group input-group-outline mb-3">
              <input value="{{$users->phone}}" name="phone" type="text" class="form-control">
            </div>
          </div>
        </div>
      <div class="row"> 
