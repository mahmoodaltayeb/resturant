              ...
              <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div class="shadow-primary border-radius-lg pt-4 pb-3 bg-gradient-dark shadow-color">
                    <h6 class="text-white text-capitalize ps-3">Edit city </h6>
                  </div>
                </div>
                <div class="card-body px-0 pb-2">
                  <div class="row">  
                    <div class="form-border rounded mt-2">
                     <form action="{{route('cities.update',$cities->id)}}" method="POST" role="form" class="mt-4 m-5">
                      @csrf
                      @method('PUT')
                      <div class="row"> 
                       <div class="col">
                        ...
                        <div class="input-group input-group-outline mb-3">
                          <input name="name" value="{{$cities->name}}" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
